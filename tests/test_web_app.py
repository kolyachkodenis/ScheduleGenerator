...
class WebApplicationTests(unittest.TestCase):
    ...
    def test_static_operator_interface_is_served(self) -> None:
        ...
        self.assertIn(b'id="alternatives" type="number" min="1" max="10" value="1"', page.body)
        self.assertIn(b'id="workers"', page.body)
        self.assertIn(b'document.querySelector("#workers").value', script.body)
